...
# 开发工具：PyCharm
# 功能：去掉重复度版本,
# 修改：去重复最佳融合位置估计标准差计算函数sigma_position
# 修改：改变生成数据部分的噪声范围
...
def main():
    ...
    # 读取已有的usv数据
    # u_data = read_json.run('E:/博士论文试验数据/chapter5/1606202166/50usv_position.json')
    # t_data = read_json.run('E:/博士论文试验数据/chapter5/1606202166/50time_noise.json')
    # t_sigma_data = read_json.run('E:/博士论文试验数据/chapter5/1606202166/50t_sigma.json')
