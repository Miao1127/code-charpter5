...
def main():
    ...
    for i in range(5, usv_num+1):
        ...
        support_m_final, list_combination, position_est_b, position_est_noise \
            = confidence_matrix_1(usv_position, time_c_n, time_sigma, save_path, s_threshold_rate=0.15)
        ...
        support_m_final_x, list_combination_x, position_est_b_x, support_m_final_y, list_combination_y, position_est_b_y\
            , position_est_noise = confidence_matrix_2(auv_position, usv_position, time_c_n, time_sigma, save_path, s_threshold_rate=0.15)
